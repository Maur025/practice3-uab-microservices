...
apiRouter.post("/empresas", empresaValidator, validate, postEmpresa);
apiRouter.put("/empresas/:id", idParamValidator, empresaUpdateValidator, validate, putEmpresa);
...
apiRouter.post("/sucursales", sucursalValidator, validate, postSucursal);
apiRouter.put("/sucursales/:id", idParamValidator, sucursalUpdateValidator, validate, putSucursal);
