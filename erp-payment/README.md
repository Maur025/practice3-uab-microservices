...
| ------ | ---------------------------------- | ---------------------------------------- |
| GET    | `/api/finanzas/cuentas-por-cobrar` | Lista las cuentas por cobrar pendientes. |
| POST   | `/api/finanzas/cuentas-por-cobrar` | Registra una nueva cuenta por cobrar.    |
| GET    | `/api/finanzas/pagos-clientes`     | Lista los pagos de clientes.             |
| POST   | `/api/finanzas/pagos-clientes`     | Registra un pago de cliente.             |
| GET    | `/api/finanzas/cuentas-por-pagar`  | Lista las cuentas por pagar pendientes.  |
| GET    | `/api/finanzas/pagos-proveedores`  | Lista los pagos de proveedores.          |
...
_(Nota: Los endpoints bajo la ruta `/outgoing` están reservados para la integración con el microservicio de Compras para el pago a proveedores)._
